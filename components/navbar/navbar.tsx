  ...
  return (
    <>
      ...
      </header>
      {
        ...
        variants={list}
        >
          <SignInModal setSignInToggler={setSignInToggler} setConnectWalletToggler={setConnectWalletToggler} />

        </motion.div>

      }
      {
        modal && (!signInToggler && connectWalletToggler) &&
        ...
        variants={list}
        >
          <ConnectWalletModal setModal={setModal} />
        </motion.div>
      }
